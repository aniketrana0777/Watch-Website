...
import { addToCard,removeToCart,removeSingleItem,emptyCartIteams } from '../redux/app/features/cartSlice';
                    ...
                    <div className="card1">
                        <div className="card-header bg-dark p-3">
                            <div className='card-header-flex'>
                                <h5 className='text-white m-0'>TIMI store {carts.length >0 ? `(${carts.length})`:""}</h5>
                                {
